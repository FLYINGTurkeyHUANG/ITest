...
public class Parser {
    ...
    private static final int BEGIN_ARRAY_TOKEN = 3;
    private static final int END_ARRAY_TOKEN = 4;
    private static final int NULL_TOKEN = 5;
    private static final int NUMBER_TOKEN = 6;
    private static final int STRING_TOKEN = 7;
    private static final int BOOLEAN_TOKEN = 8;
    private static final int SEP_COLON_TOKEN = 9;
    private static final int SEP_COMMA_TOKEN = 10;

    private JSONTokenList tokens;

    public Object parse(JSONTokenList tokens) {
        this.tokens = tokens;
        return parse();
    }
    ...
    private Object parse() {
        ...
        } else if (token.getTokenType() == JSONTokenType.BEGIN_OBJECT) {
            return parseJsonObject();
        } else if (token.getTokenType() == JSONTokenType.BEGIN_ARRAY) {
